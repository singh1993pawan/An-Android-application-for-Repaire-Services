...
public class Update_Address extends AppCompatActivity {
    ...
    public void UpdateAddress(View view) {
        ...
        BackgroundUpdateAddress backgroundUpdateAddress = new BackgroundUpdateAddress(this);
    ...
    class BackgroundUpdateAddress extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            user = params[2];
            String reset_url = "http://andromeda.nitc.ac.in/~m140383ca/UpdateAddress.php";
