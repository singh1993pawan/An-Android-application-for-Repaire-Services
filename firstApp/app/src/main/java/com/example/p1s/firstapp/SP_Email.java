...
public class SP_Email extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sp__email);
        ...
        t.setText(userID);
        //Toast.makeText(this,new_email.getText(), Toast.LENGTH_SHORT).show();


    }


    public void SPUpdateEmail(View view) {
        String newemail = new_email.getText().toString();
        String type = "update";

        SP_Email.BackgroundUpdateEmail backgroundUpdateEmail = new SP_Email
                .BackgroundUpdateEmail(this);
    ...
    class BackgroundUpdateEmail extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            user = params[2];
            String reset_url = "http://andromeda.nitc.ac.in/~m140383ca/SPUpdateEmail.php";
