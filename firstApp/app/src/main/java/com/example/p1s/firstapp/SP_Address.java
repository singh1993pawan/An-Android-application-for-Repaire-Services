...
public class SP_Address extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sp__address);

        address = (EditText) findViewById(R.id.updatedaddress);
    ...
    public void UpdateAddress(View view) {
        ...
        SP_Address.BackgroundUpdateAddress backgroundUpdateAddress = new SP_Address
                .BackgroundUpdateAddress(this);
        backgroundUpdateAddress.execute(type, newaddress, user);
    ...
    class BackgroundUpdateAddress extends AsyncTask<String, Void, String> {
        ...
        BackgroundUpdateAddress(Context ctx) {
            this.ctx = ctx;
        }
        ...
        protected String doInBackground(String... params) {
            ...
            user = params[2];
            String reset_url = "http://andromeda.nitc.ac.in/~m140383ca/SPUpdateAddress.php";
            ...
            if (type.equals("update")) {
                try {
                    ...
                    BufferedWriter bufferedWriter = new BufferedWriter(new OutputStreamWriter
                            (outputStream, "UTF-8"));
                    String post_data = URLEncoder.encode("identifier_address", "UTF-8") + "=" +
                            URLEncoder
                                    .encode(address, "UTF-8")+"&"+URLEncoder.encode("identifier_email",
        ...
        protected void onPostExecute(String result) {
            ...
            if (result.equalsIgnoreCase("1")) {
                ...
                mbuilder.setMessage("YOUR OLD AND NEW ADDRESS ARE SAME");
                ...
                AlertDialog.Builder mbuilder = new AlertDialog.Builder(ctx);
                mbuilder.setMessage("SUCCESSFULL UPDATE ADDRESS ");
                mbuilder.setTitle("UPDATE INFORMATION");
                mbuilder.setPositiveButton("Dismiss", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
