...
import com.example.p1s.firstapp.mRecycler.FMyAdapter;
...
public class FDataParser extends AsyncTask<Void,Void,Integer> {
    ...
    public FDataParser(Context c, RecyclerView rv, String jsonData,String type) {
        this.c = c;
        this.rv = rv;
    ...
    protected void onPostExecute(Integer result) {
        ...
        if (result==0)
        {
            ...
            FMyAdapter adapter=new FMyAdapter(c,spacecraft,type);
    ...
    private int parseData()
    {
        try {
            ...
            for (int i=0;i<ja.length();i++)
            {
                ...
                String prize = jo.getString("value");
