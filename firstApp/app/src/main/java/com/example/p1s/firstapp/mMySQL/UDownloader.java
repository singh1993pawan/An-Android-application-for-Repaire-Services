...
public class UDownloader extends AsyncTask<Void,Void,String> {
    ...
    public UDownloader(Context c, String urlAddress, RecyclerView rv,String type) {
        this.c = c;
    ...
    protected void onPostExecute(String s) {
        ...
        if (s==null)
        {
            ...
            UDataParser parser = new UDataParser(c,rv,s,type);
            parser.execute();
