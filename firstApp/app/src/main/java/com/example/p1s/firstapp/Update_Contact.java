...
public class Update_Contact extends AppCompatActivity {
    ...
    public void UpdateContact(View view) {
        ...
        BackgroundUpdateContact backgroundUpdateContact = new BackgroundUpdateContact(this);
    ...
    class BackgroundUpdateContact extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            user = params[2];
            String reset_url = "http://andromeda.nitc.ac.in/~m140383ca/UpdateContact.php";
